...
class ResNetStyle_22(nn.Module):
    def __init__(self):
        ...
        self.f0 = nn.Conv2d(in_channels=1, out_channels=64, kernel_size=(27, 27), stride=(1, 1), padding=(0, 0), dilation=(1, 1), groups=1, bias=True, padding_mode='zeros')
        self.f1 = nn.Conv2d(in_channels=64, out_channels=10, kernel_size=(2, 2), stride=(1, 1), padding=(0, 0), dilation=(1, 1), groups=1, bias=True, padding_mode='zeros')

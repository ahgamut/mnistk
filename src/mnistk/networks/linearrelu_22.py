...
class LinearReLU_22(nn.Module):
    def __init__(self):
        ...
        self.f2 = nn.Linear(in_features=59, out_features=49, bias=False)
        self.f3 = nn.ReLU(inplace=False)
        self.f4 = nn.Linear(in_features=49, out_features=44, bias=False)
        self.f5 = nn.Linear(in_features=44, out_features=22, bias=False)
        self.f6 = nn.ReLU(inplace=False)
        self.f7 = nn.Linear(in_features=22, out_features=12, bias=False)

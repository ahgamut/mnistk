...
class LinearReLU_23(nn.Module):
    def __init__(self):
        ...
        self.f0 = nn.Linear(in_features=784, out_features=58, bias=False)
        self.f1 = nn.ReLU(inplace=False)
        self.f2 = nn.Linear(in_features=58, out_features=17, bias=False)
        self.f3 = nn.ReLU(inplace=False)
        self.f4 = nn.Linear(in_features=17, out_features=14, bias=False)

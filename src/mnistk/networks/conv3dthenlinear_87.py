...
class Conv3dThenLinear_87(nn.Module):
    def __init__(self):
        ...
        self.f1 = nn.Tanh()
        self.f2 = nn.Conv3d(in_channels=35, out_channels=10, kernel_size=(15, 6, 6), stride=(1, 1, 1), padding=(0, 0, 0), dilation=(1, 1, 1), groups=1, bias=False, padding_mode='zeros')

...
class ResNetStyle_58(nn.Module):
    def __init__(self):
        ...
        self.f2 = nn.Conv2d(in_channels=45, out_channels=48, kernel_size=(18, 18), stride=(1, 1), padding=(0, 0), dilation=(1, 1), groups=1, bias=False, padding_mode='zeros')
        self.f3 = nn.ReLU(inplace=False)
        self.f4 = nn.Linear(in_features=4800, out_features=10, bias=True)

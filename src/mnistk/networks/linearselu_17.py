...
class LinearSELU_17(nn.Module):
    def __init__(self):
        ...
        self.f0 = nn.Linear(in_features=784, out_features=28, bias=True)
        self.f1 = nn.Linear(in_features=28, out_features=15, bias=False)
        self.f2 = nn.Linear(in_features=15, out_features=13, bias=True)

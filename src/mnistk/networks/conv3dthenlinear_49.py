...
class Conv3dThenLinear_49(nn.Module):
    def __init__(self):
        ...
        self.f1 = nn.Conv3d(in_channels=26, out_channels=10, kernel_size=(11, 2, 2), stride=(1, 1, 1), padding=(0, 0, 0), dilation=(1, 1, 1), groups=1, bias=True, padding_mode='zeros')

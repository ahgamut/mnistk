...
class Conv3dThenLinear_21(nn.Module):
    def __init__(self):
        ...
        self.f1 = nn.Linear(in_features=230, out_features=49, bias=False)
        self.f2 = nn.SELU(inplace=False)
        self.f3 = nn.Linear(in_features=49, out_features=20, bias=True)
        self.f4 = nn.SELU(inplace=False)
        self.f5 = nn.Linear(in_features=20, out_features=18, bias=False)
        self.f6 = nn.SELU(inplace=False)
        self.f7 = nn.Linear(in_features=18, out_features=16, bias=True)

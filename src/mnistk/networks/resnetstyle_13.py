...
class ResNetStyle_13(nn.Module):
    def __init__(self):
        ...
        self.f2 = nn.Conv2d(in_channels=32, out_channels=47, kernel_size=(18, 18), stride=(1, 1), padding=(0, 0), dilation=(1, 1), groups=1, bias=False, padding_mode='zeros')

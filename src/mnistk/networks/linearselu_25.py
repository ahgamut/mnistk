...
class LinearSELU_25(nn.Module):
    def __init__(self):
        ...
        self.f2 = nn.Linear(in_features=74, out_features=13, bias=False)
        self.f3 = nn.SELU(inplace=False)
        self.f4 = nn.Linear(in_features=13, out_features=11, bias=True)
        ...
        self.f10 = nn.Linear(in_features=10, out_features=10, bias=True)

...
class ResNetStyle_67(nn.Module):
    def __init__(self):
        ...
        self.f4 = nn.Conv2d(in_channels=10, out_channels=32, kernel_size=(6, 6), stride=(1, 1), padding=(0, 0), dilation=(1, 1), groups=1, bias=False, padding_mode='zeros')
        self.f5 = nn.Linear(in_features=2048, out_features=10, bias=False)

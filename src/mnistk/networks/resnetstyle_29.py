...
class ResNetStyle_29(nn.Module):
    def __init__(self):
        ...
        self.f2 = nn.Conv2d(in_channels=46, out_channels=19, kernel_size=(7, 7), stride=(1, 1), padding=(0, 0), dilation=(1, 1), groups=1, bias=True, padding_mode='zeros')
        self.f3 = nn.Linear(in_features=3211, out_features=10, bias=False)
